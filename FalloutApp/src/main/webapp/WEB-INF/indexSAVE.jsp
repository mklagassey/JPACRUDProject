...
<div class="container-fluid">
	<center><h1 style="border: 1px; border-style: solid; border-color: black; padding: .2em; width: fit-content;">FALLOUT CHARACTER LOG</h1></center>
	
	<br>
	<br>
	
	<h3 style="border: 1px; border-style: solid; border-color: black; padding: .2em; width: fit-content;">Enter Character's Serial#</h3>
	<form action="GetCharData.do" method="GET">
		Serial#:
		<input type="text" name="charId" size="4"/> 
